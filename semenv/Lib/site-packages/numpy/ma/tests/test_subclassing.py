...
class TestSubclassing:
    ...
    def test_subclass_items(self):
        ...
        assert_(isinstance(mxcsub[1,...].rawData, ComplicatedSubArray))
        assert_(mxcsub[0] is masked)
        assert_(isinstance(mxcsub[0,...].rawData, ComplicatedSubArray))
        assert_(isinstance(mxcsub[1:4].rawData, ComplicatedSubArray))

        # also for flattened version (which goes via MaskedIterator)
        assert_(isinstance(mxcsub.flat[1].rawData, ComplicatedSubArray))
    ...
    def test_subclass_nomask_items(self):
        ...
        assert_(isinstance(mxcsub_nomask[1,...].rawData, ComplicatedSubArray))
        assert_(isinstance(mxcsub_nomask[0,...].rawData, ComplicatedSubArray))
...
def test_array_no_inheritance():
    ...
    assert_equal(data_masked.rawData, new_array.rawData)
