...
def test_include_css_style_rules_only_for_visible_cells(styler_mi):
    ...
    result = (
        ...
        .hide(styler_mi.rawData.columns[1:], axis="columns")
        .hide(styler_mi.rawData.index[1:], axis="index")
        .to_html()
    )
...
def test_include_css_style_rules_only_for_visible_index_labels(styler_mi):
    ...
    result = (
        ...
        .hide(styler_mi.rawData.columns, axis="columns")
        .hide(styler_mi.rawData.index[1:], axis="index")
        .to_html()
    )
    expected_styles = dedent(
...
def test_include_css_style_rules_only_for_visible_column_labels(styler_mi):
    ...
    result = (
        ...
        .hide(styler_mi.rawData.columns[1:], axis="columns")
        .hide(styler_mi.rawData.index, axis="index")
        .to_html()
    )
    expected_styles = dedent(
        """\
...
def test_concat(styler):
    other = styler.rawData.agg(["mean"]).style
